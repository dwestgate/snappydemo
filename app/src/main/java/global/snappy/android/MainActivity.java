    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cmdIdentifyUser).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                branch.setIdentity("test_user_10", new Branch.BranchReferralInitListener() {
                    @Override
        ...
        findViewById(R.id.cmdClearUser).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.cmdPrintInstallParam).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.cmdRefreshShortURL).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.cmdRefreshReward).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
        ...
        findViewById(R.id.cmdRedeemFive).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                branch.redeemRewards(5, new Branch.BranchReferralStateChangedListener() {
                    @Override
                    public void onStateChanged(boolean changed, BranchError error) {
                        if (error != null) {
        ...
        findViewById(R.id.cmdCommitBuyAction).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.cmdCommitBuyMetadataAction).setOnClickListener(new View.OnClickListener() {
        ...
        findViewById(R.id.cmdGetCreditHistory).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.report_view_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
